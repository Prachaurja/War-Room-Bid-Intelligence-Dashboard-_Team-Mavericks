...
# Use sync URL from .env (single source of truth). Alembic requires a sync driver (e.g. psycopg2).
# ConfigParser treats "%" as interpolation; escape literal percent signs in passwords.
